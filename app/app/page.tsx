          ...
          <HeaderWrapper>
            <div className="max-w-[900px] mx-auto w-full flex justify-between items-center">
              ...
              <div className="flex gap-8 items-center">
                {/* Builds remaining indicator for free users */}
                {profile && profile.subscription_status === 'free' && (
                  <span className="text-label-small text-black-alpha-48 mr-4">
                    {Math.max(0, 3 - (profile.builds_this_month || 0))}/3 builds left
                  </span>
                )}
                {profile && profile.subscription_status === 'pro' && (
                  <span className="text-label-small text-heat-100 mr-4 font-medium">Pro</span>
                )}
                <Link href="/dashboard">
                  <ButtonUI variant="tertiary">Dashboard</ButtonUI>
                </Link>
                <button
                ...
                {user && (
                  <div className="w-28 h-28 rounded-full bg-heat-100 flex items-center justify-center text-white text-label-small font-medium">
              ...
              <div className="relative h-[250px] overflow-hidden">
                ...
                <div className="carousel-container absolute left-0 flex gap-12 py-4">
                  {[...Array(10), ...Array(10)].map((_, index) => (
                    <div key={`loading-${index}`} className="flex-shrink-0 w-[400px] h-[240px] rounded-lg overflow-hidden border-2 border-gray-200/30 bg-white relative">
                    ...
                    >
                        ...
                        {showInstructionsForIndex === index ? (
                          <div className="w-full max-w-[380px]">
                            <div className="bg-white rounded-20" style={{
                              boxShadow: "0px 0px 44px 0px rgba(0, 0, 0, 0.02), 0px 88px 56px -20px rgba(0, 0, 0, 0.03)"
                            }}>
                              <div className="p-16 flex gap-12 items-start w-full relative">
                                <div className="mt-2 flex-shrink-0">
                                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-40">
                              ...
                              <div className="p-10 flex justify-between items-center">
                                ...
                                <button
                                  ...
                                  className={`button relative rounded-10 px-8 py-8 text-label-medium font-medium flex items-center justify-center gap-6 ${additionalInstructions.trim() ? 'button-primary text-accent-white active:scale-[0.995]' : 'bg-black-alpha-4 text-black-alpha-24 cursor-not-allowed'}`}
                                >
                                  ...
                                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative">
                          ...
                          <>
                            ...
                            <div className="flex gap-3 justify-center">
                              <button
                                onClick={(e) => { e.stopPropagation(); handleSubmit(result); }}
                              ...
                              <button
                                onClick={(e) => { e.stopPropagation(); setShowInstructionsForIndex(index); setAdditionalInstructions(''); }}
                      ...
                      {result.screenshot ? (
                        <div className="relative w-full h-full">
                          <Image src={result.screenshot} alt={result.title} fill className="object-cover object-top" loading="lazy" />
                        </div>
                      ) : (
