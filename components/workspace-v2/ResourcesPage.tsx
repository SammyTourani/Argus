...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    ...
    fetchCurrentUser().then(function(user) {
      ...
      var logo = document.querySelector('.page-resources .sidebar-logo');
      var title = document.querySelector('.page-resources .sidebar-title');
    ...
    fetchRecents().then(function(recents) {
      if (cancelled) return;
      var container = document.getElementById('resourcesRecents');
      if (!container) return;
  ...
  return (
    <div className="app page-resources">
      ...
      <aside className="sidebar">
        ...
        <div style={{ padding: '0 8px 12px' }} id="resourcesRecents">
          <div className="nav-item" style={{ color: 'var(--fg-muted)', fontSize: '12px', pointerEvents: 'none' }}>Loading...</div>
        </div>

        <div className="sidebar-footer">
          <div className="sidebar-footer-item" id="resourcesShareBtn" style={{ cursor: 'pointer' }}>
